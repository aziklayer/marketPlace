# Generated by Django 4.0 on 2024-01-20 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_flag', models.CharField(choices=[('p', 'товар оплачен'), ('n', 'не оплачен')], default='n', max_length=1, verbose_name='статус оплаты')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart_product', models.ManyToManyField(to='app_shop.GoodCart', verbose_name='товар из корзины')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth.user', verbose_name='пользователь')),
            ],
            options={
                'verbose_name': 'заказ',
