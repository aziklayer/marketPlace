# Generated by Django 4.0 on 2024-01-20 17:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('good_num', models.PositiveIntegerField(default=1, verbose_name='количество')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('balance', models.FileField(default=0, upload_to='', verbose_name='баланс')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart_good', models.ManyToManyField(to='app_shop.GoodCart', verbose_name='товары из корзины')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth.user', verbose_name='пользователь')),
            ],
            options={
                'verbose_name': 'заказ',
