...
class Profile(models.Model):
    ...
    status_flag = models.CharField(choices=status_choices, max_length=3, default='new',
...
class Shop(models.Model):
    ...
    log = models.ImageField(upload_to='shop_logo/', verbose_name='логотип')
...
class Good(models.Model):
    ...
    activity_flag = models.CharField(choices=activity_choices, max_length=1, default='i',
...
class Order(models.Model):
    ...
    cart_product = models.ManyToManyField(GoodCart, verbose_name='товар из корзины')
